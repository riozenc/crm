 ...
 */
package crm.common.mybatis.page;
...
import com.riozenc.quicktool.common.util.http.CookieUtils;
...
public class Page<T> {
	...
	private long bmCount;// 版面总数
	private boolean bmCountFlag;// 是否显示版面
	...
	public long getBmCount() {
		return bmCount;
	}

	public void setBmCount(long bmCount) {
		this.bmCount = bmCount;
	}

	public boolean isBmCountFlag() {
		return bmCountFlag;
	}

	public void setBmCountFlag(boolean bmCountFlag) {
		this.bmCountFlag = bmCountFlag;
	}
